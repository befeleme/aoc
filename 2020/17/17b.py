...
def count_occupied_neighbours(seat):
    ...
    for offset in offsets:
        off_x, off_y, off_z, off_w = offset
        new_x, new_y, new_z, new_w = x + off_x, y + off_y, z + off_z, w + off_w
        while True:
            new_point = new_x, new_y, new_z, new_w
